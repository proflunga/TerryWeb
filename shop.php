                        ...
                        <div class="shop-sidebar-wrapper">
                            ...
                            <div class="sidebar-search-box-style2 wow fadeInUp animated" data-wow-delay="0.1s" data-wow-duration="1200ms">
                                <form class="search-form" action="#">
                                    <input placeholder="Shop Products" type="text" disabled>
                                </form>
                            </div>
                        ...
                        <div class="shop-content-box">
                            <div class="row">
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                                    <div class="single-product-item style1instyle2 wow fadeInUp animated animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                                        <div class="img-holder">
                                            <img src="assets/images/shop/commercial-beef.jpg" alt="Awesome Product Image">
                                            <div class="overlay-style-one">
                                                <div class="box">
                                                    <div class="content">
                                                        <div class="zoom-button">
                                                            <a class="lightbox-image" data-fancybox="gallery" href="assets/images/shop/commercial-beef.jpg">
                                                                <span class="icon-magnifiying-glass"></span>
                                                            </a>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="title-holder">
                                            <h4 class="product-title"><a href="shop-single.html">Commercial Beef</a></h4>
                                            <div class="review-box">
                                                <ul>
                                                    <li><i class="fa fa-star"></i></li>
                                                    <li><i class="fa fa-star"></i></li>
